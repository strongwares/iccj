...
public class DeleteIotaDbWorker extends ActionResponseAbstractApiWorker {

    public DeleteIotaDbWorker(Localizer localizer, ServerPanel serverPanel,
    ...
    protected void done() {
        ...
        if (bre != null) {
            ...
            UiUtil.showErrorDialog("Server " + ctlr.name + " " + localizer.getLocalText("consoleLogApiCallDeleteDb"),
